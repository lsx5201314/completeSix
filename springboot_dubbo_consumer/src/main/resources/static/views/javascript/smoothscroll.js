!
    function(t, e) {
        ...
        function(t, e, o) {
            ...
            function m(t, e, o) {
                o.forEach(function(o) { - 1 === e.indexOf(o) && p(t, o) && u(t, o)
                }),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    if (this.enabled) {
                                        ...
                                        d = w(d, c),
                                            p = w(p, g);
                                        for (var m = h.left + p.left - d.left,
                                                 v = h.top + p.top - d.top,
                                        ...
                                        var E = {
                                            ...
                                            T = A.defaultView,
                                            S = void 0;
                                        return A.body.scrollWidth > T.innerWidth && (S = this.cache("scrollbar-size", l), E.viewport.bottom -= S.height),
                                ...
                                value: function(t) {
                                    ...
                                    if ("undefined" != typeof this.element.parentNode) {
                                        ...
                                        var l = {
                                            ...
                                            d = !1;
                                        if ((o.page.top || o.page.bottom) && (o.page.left || o.page.right) ? (l.position = "absolute", u(o.page, t.page)) : (o.viewport.top || o.viewport.bottom) && (o.viewport.left || o.viewport.right) ? (l.position = "fixed", u(o.viewport, t.viewport)) : "undefined" != typeof o.offset && o.offset.top && o.offset.left ? !
                                            function() {
                                                l.position = "absolute";
            ...
            x.modules.push({
                position: function(t) {
                    ...
                    var u = this.cache("target-bounds",
                        function() {
                    ...
                    return this.options.constraints.forEach(function(t) {
                        ...
                        var b = O(e, r); ("target" === u || "both" === u) && (o < b[1] && "top" === v.top && (o += d, v.top = "bottom"), o + s > b[3] && "bottom" === v.top && (o -= d, v.top = "top")),
                        ...
                        ("element" === u || "both" === u) && (o < b[1] && "bottom" === y.top && (o += s, y.top = "top"), o + s > b[3] && "top" === y.top && (o -= s, y.top = "bottom")),
